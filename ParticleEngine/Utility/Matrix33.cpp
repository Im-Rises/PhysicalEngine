...
Matrix33 Matrix33::inverse() const
{
	...
	float det2 = m_value[3*0+ 1] * ((m_value[3*1+ 0]) * (m_value[3*2+ 2]) - (m_value[3*2+ 0] * m_value[3*1+ 2]));
	float det3 = m_value[3*0+ 2] * ((m_value[3*1+ 0]) * (m_value[3*2+ 1]) - (m_value[3*2+ 0] * m_value[3*1 +1]));
	...
	if (determinant == 0) {
		...
		Matrix33 res = Matrix33();
		res.m_value[0] = ((m_value[3*1+ 1] * m_value[3*2+ 2]) - (m_value[3*2+ 1] * m_value[3*1+ 2])) / determinant;
		res.m_value[1] = -((m_value[3*1+ 0] * m_value[3*2+ 2]) - (m_value[3*2+ 0] * m_value[3*1+ 2]) / determinant);
		res.m_value[2] = +((m_value[3*1+ 0] * m_value[3*2+ 1]) - (m_value[3*2+ 0] * m_value[3*1+ 1]) / determinant);
		res.m_value[3] = -((m_value[3*0+ 1] * m_value[3*2+ 2]) - (m_value[3*2+ 1] * m_value[3*0+ 2]) / determinant);
		res.m_value[4] = +((m_value[3*0+ 0] * m_value[3*2+ 2]) - (m_value[3*2+ 0] * m_value[3*0+ 2]) / determinant);
		res.m_value[5] = -((m_value[3*0+ 0] * m_value[3*2+ 1]) - (m_value[3*2+ 0] * m_value[3*0+ 1]) / determinant);
		res.m_value[6] = +((m_value[3*0+ 1] * m_value[3*1+ 2]) - (m_value[3*1+ 1] * m_value[3*0+ 2]) / determinant);
		res.m_value[7] = -((m_value[3*0+ 0] * m_value[3*1+ 2]) - (m_value[3*1+ 0] * m_value[3*0+ 2]) / determinant);
		res.m_value[8] = +((m_value[3*0+ 0] * m_value[3*1+ 1]) - (m_value[3*1+ 0] * m_value[3*0+ 1]) / determinant);
		return res;
